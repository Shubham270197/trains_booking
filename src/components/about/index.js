        ...
        <div>
            ...
            <div className="about-text">
                <div className="container">
                    <h2 className="line">{appConstants.WhoWeAretitleone} <span className="color-d"> {appConstants.WhoWeAretitletwo}</span> {appConstants.WhoWeAretitlethree}</h2>
                    <div className="text-line">
                        <img src={images.border1} style={{ width: '400px' }} />
                    </div>
                    <p className="text-about">
                       {appConstants.aboutdata}
                    </p>
                </div>
            </div>
                ...
                <div className="container">
                    ...
                    <div className="row text-black">
                        <div className="col-sm-6">
                            ...
                            <p className="text-about">{appConstants.textabout}
                        ...
                        <div className="col-sm-6">
                            ...
                            <p className="text-about">{appConstants.earlytextthird}
                            </p>
            ...
            <div className="about-text investors">
                ...
                <p>We have many investors from many countries. They trust us because we love what we do.
                </p>
