...
const Careers = (props) => {
  ...
  const carrerdata = [
    ...
    decription: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
      ...
      <div className="mobileabout">
            ...
            <div className="working">
                <div className="container">
                    ...
                    <h2 className="line">{appConstants.titlerolesone} <span className="color-d">{appConstants.titlerolestwo}</span> {appConstants.titlerolethree}</h2>
        ...
        <div className="culture">
                <div className="container">
                    ...
                    <h2 className="line">Our<span className="color-d"> Culture</span></h2>
