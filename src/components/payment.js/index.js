                        ...
                        <div className="row">
                            ...
                            <div className="text_wrapper_w payments pay_div crds-new">
                                    ...
                                    <div className="first d-flex ">
                                        ...
                                        <div className="d-flex  card-div-crs" style={{width:'100%'}}>
                                            ...
                                            <div class="text-center"><button class="button text" style={{padding:'0px 6px',minWidth:'170px'}}>Add New Card</button></div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-sm-6 left-paymnets">
                                <div className="text_wrapper_w payments pay_div">
                                    ...
                                    <div class="text-center button-center"><button class="button text">Pay</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
