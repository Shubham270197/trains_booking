                        ...
                        <div className="row">
                                    ...
                                    <div className="first d-flex cards_text ">
                                        {
                                            cardvalue == "1" ?
                                                ...
                                                <div className="d-flex  card-div-crs" style={{ width: '100%' }}>
                                                    ...
                                                    <div class="text-center"><button class="button text" style={{ padding: '0px 6px', minWidth: '170px' }} onClick={() => { setCardValue(2) }}>Add New Card</button></div>
                                                </div>
                                                :
                                                <div className="d-flex  card-div-crs " style={{ width: '100%' }}>
                                                    <h2>Card Details</h2>
                                                    <p>XXXX XXXX XXXX 6543</p>
                                                    <div class="text-center button-center pay-button"><button class="button text" onClick={() => { setCardValue(1) }}>Remove</button></div>
                                                </div>
                                        }
                                    </div>
                                    ...
                                    <div className="text_wrapper_w payments">
                                        ...
                                        <div className="first d-flex">
                                            <div className="d-flex permitted">
                                                <span><img src={images.text_1} /></span>
                                    ...
                                    <div className="text_wrapper_w payments">
                                        ...
                                        <div className="first d-flex shipping_line_one">
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <h2>Manchester Piccadilly, Victoria, Oxford Road, Deansgate</h2>
                                            </div>
                            ...
                            <div className="col-sm-6 left-paymnets">
                                <div className="text_wrapper_w payments pay_div">
                                    ...
                                    <div class="text-center button-center"><button class="button text" onClick={()=>navigate('/mybookings')}>Pay</button></div>
                                </div>
                            </div>
